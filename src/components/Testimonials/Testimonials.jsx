            ...
            <li>
                <div className="slide">
                    <div className="user-info">
                        ...
                        <p>
                            Choosing to pursue my degree at Edusity wa sone of the best decisions I've ever made. The supportive community, state-of-the-art facilities, and commitment to academic excellence have truly exceeded my expeactations.
                        </p>
                    </div>
                </div>
            </li>
